            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">                    
                    <div class="form-group">                       
                            ...
                            <img id="myImg" src="<?php echo e(asset('packages/larapress/src/Assets/admin/img/dummy-image-square.jpg')); ?>" width="100%" height="auto" data-toggle="modal" data-target="#exampleModalCenter" class="border border-info">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /skl/home/devailsnew/public_html/meghna-cards/packages/larapress/src/Resources/views/admin/posttypes/underposttype/createppost.blade.php ENDPATH**/ ?>