...
?>   
    <section id="about" class="about section">
        <div class="container valetineiconbox">
            <div class="row gy-4 justify-content-center text-center">
                ...
                <?php if($post->category_main_id == 1): ?>               
    ...
    </section><?php /**PATH /skl/home/devailsnew/public_html/meghna-cards/resources/views/front/template/meghna_type/meghna_type.blade.php ENDPATH**/ ?>